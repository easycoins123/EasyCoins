...
export interface CartBenefits {
  ...
  /** The launch offer on this order, when the welcome benefit applies, and the coins it adds. */
  readonly campaignId?: string;
  readonly campaignCoins: number;
}

export const NO_BENEFITS: CartBenefits = { applied: [], rejected: [], rewardCoins: 0, campaignCoins: 0 };
