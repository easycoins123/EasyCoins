...
import {
  MOCK_NO_BENEFITS, onOrderPaid, redeemForOrder, redeemable, releaseForOrder, reserveReward,
...
export function priceMockCart(backend: MockBackendService, cart: Cart): PricedMockCart {
  ...
  return {
    ...
    benefits: { applied, rejected, rewardId: rewardApplied && check?.reward ? check.reward.id : undefined, rewardCoins },
  };
}
