...
// Custom amounts are priced from the ladder of the edition on sale, never a retired one.
const COIN_PRODUCT_SLUG = MOCK_STOREFRONT.editions.find((edition) => edition.id === MOCK_STOREFRONT.activeEdition)?.productSlug ?? 'fc27-coins';
